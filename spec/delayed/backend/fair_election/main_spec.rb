  ...
  describe 'process Jobs' do
    ...
    context 'when ranks calculated' do
      let(:expected_ranks) do
        [
          { fair_id: 'A', busy: 2, waiting: 1, rank: -201 },
          { fair_id: 'B', busy: 1, waiting: 1, rank: -101 },
          { fair_id: 'C', busy: 0, waiting: 1, rank: 0 },
          { fair_id: 'D', busy: 2, waiting: 0, rank: -200 },
          { fair_id: 'E', busy: 0, waiting: 4, rank: 0 },
        ]
      end
